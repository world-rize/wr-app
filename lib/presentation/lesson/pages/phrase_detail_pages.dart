...
class PhraseDetailPageViewPage extends StatefulWidget {
  const PhraseDetailPageViewPage(
  ...
  @override
  _PhraseDetailPageViewPageState createState() =>
      _PhraseDetailPageViewPageState(
        section: section,
        index: index,
      );
}

class _PhraseDetailPageViewPageState extends State<PhraseDetailPageViewPage>
